...
def get_File_Reference_DB(db_name:str):
    """Base de datos para almacenar REFERENCIAS de archivos con sus tags asociados(basicamente los mismo que una File_Tag_BD pero sin almacenar el contenido de los archivos)"""
