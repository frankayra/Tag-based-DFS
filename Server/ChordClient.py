    ...
    def RetakePendingOperation(self, node_reference, operation, info):
        ...
        with grpc.insecure_channel(node_reference.uri_address) as channel:
            ...
            match operation:
                ...
                # case communication_messages.ADD_TAGS_TO_REPLICATED_FILES:
                ...
                # case communication_messages.DELETE_TAGS_FROM_REPLICATED_FILES:
...
# Replication y referencias
# ----------------------------------
    def replicate(self, stub, node_reference, info): pass
    def send_raw_database_replica(self, stub, node_reference, info): pass
    # def add_references(self, stub, node_reference, info): pass
    def delete_files_replicas(self, stub, node_reference, info): pass
...
# ----------------------------------
    ...
    def add_tags_to_replicated_files(self, stub, node_reference, info): pass
    # def delete_tags_from_refered_files(self, stub, node_reference, info): pass
    def delete_tags_from_replicated_files(self, stub, node_reference, info): pass


# Protocolo Heartbeat y AliveRequest (para replicas y nodos proximos respectivamente)
# ----------------------------------
    def heartbeat(self, stub, node_reference, info): pass
    def alive_request(self, stub, node_reference, info): pass
    def unreplicate(self, stub, node_reference, info): pass


# Entrada de un nodo a la red
# ----------------------------------
    # def node_entrance_request(self, stub, node_reference, info): pass
    def i_am_your_next(self, stub, node_reference, info): pass
    def update_next(self, stub, node_reference, info): pass
    def files_allotment_transfer(self, stub, node_reference, info): pass
    def update_replication_clique(self, stub, node_reference, info): pass


# Salida de un nodo de la red
# ----------------------------------
    def i_am_your_prev(self, stub, node_reference, info): pass


# Actualizar finger tables
# ----------------------------------
    def update_finger_table(self, stub, node_reference, info): pass
    def update_finger_table_forward(self, stub, node_reference, info): pass
